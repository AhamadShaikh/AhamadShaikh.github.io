      ...
      <div className="container about_container">
        ...
        <div className="about_content">
          ...
          <p id="user-detail-intro" className={theme === "dark" ? "text-dark" : "text-light"}>
            ...
            looking for new challenges and opportunities.My proficiency in a wide range of programming languages, frameworks, and technologies using HTML,CSS,JavaScript,React,Redux,TypeScript,Node,Express and MongoDB allows me to tackle complex projects with ease and efficiency.
          </p>
